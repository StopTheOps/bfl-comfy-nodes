...
class FluxBase:
    ...
    def call(self, *args, **kwargs):
        ...
        if headers["x-key"] is None:
            raise Exception(
                "No Black Forest Labs API key set. Set environment variable BFL_API_KEY, "
                "insert key into bfl_api_key.txt, or use 'api_key_override' field."
            )
...
class FluxPro11Ultra(FluxBase):
    ...
    INPUT_SPEC = {
        "required": {"prompt": ("STRING", {"multiline": True})},
        "optional": {
            "seed": ("INT", {"default": -1, "min": -1, "max": 4294967294}),
...
NODE_CLASS_MAPPINGS = {
    ...
    "FLUX 1.1 Ultra [pro]": FluxPro11Ultra,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "FLUX 1.1 Ultra [pro]": "FLUX 1.1 Ultra [pro]",
}
